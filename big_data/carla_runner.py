...
VEHICLE_COUNT   = 60                # number of NPC vehicles to spawn (50–200)
SIMULATION_FPS  = 20                # fixed simulation timestep
DURATION_SECS   = 460               # how long to run (seconds of sim time)
...
def collect_vehicle_snapshot(vehicles, tick_number: int, weather_code: int) -> list:
    ...
    """
    density_map = compute_traffic_density(vehicles)
    rows = []
